...
function i(e5) {
  ...
  return i = typeof Symbol == `function` && typeof Symbol.iterator == `symbol` ? function(e6) {
    return typeof e6;
  } : function(e6) {
...
function a(e5, t2) {
  if (i(e5) != `object` || !e5) return e5;
  var n2 = e5[Symbol.toPrimitive];
  if (n2 !== void 0) {
    var r2 = n2.call(e5, t2 || `default`);
    if (i(r2) != `object`) return r2;
    throw TypeError(`@@toPrimitive must return a primitive value.`);
  }
  return (t2 === `string` ? String : Number)(e5);
}
function o(e5) {
  var t2 = a(e5, `string`);
  return i(t2) == `symbol` ? t2 : t2 + ``;
}
function s(e5, t2, n2) {
  return (t2 = o(t2)) in e5 ? Object.defineProperty(e5, t2, { value: n2, enumerable: true, configurable: true, writable: true }) : e5[t2] = n2, e5;
}
var c = class {
...
var l = class {
  constructor() {
    s(this, `_lastHandleId`, 0), s(this, `_lastImmediate`, null);
  }
  requestAnimationFrame(e5) {
...
var u = class {
  constructor() {
    s(this, `_strategy`, void 0), this._strategy = typeof requestAnimationFrame == `function` ? new c() : new l();
  }
  requestAnimationFrame(e5) {
...
var d = typeof window < `u` && window.document !== void 0;
var f = new Uint8Array([80, 75, 3, 4]);
var p = [`v`, `ip`, `op`, `layers`, `fr`, `w`, `h`];
var m = `0.70.0`;
var h = `@lottiefiles/dotlottie-web`;
var g;
var _ = typeof TextDecoder < `u` ? new TextDecoder(`utf-8`, { ignoreBOM: true, fatal: true }) : { decode: () => {
  throw Error(`TextDecoder not available`);
} };
typeof TextDecoder < `u` && _.decode();
var v = null;
function y() {
  return (v === null || v.byteLength === 0) && (v = new Uint8Array(g.memory.buffer)), v;
}
function b(e5, t2) {
  return e5 >>>= 0, _.decode(y().subarray(e5, e5 + t2));
}
function x(e5) {
  let t2 = g.__externref_table_alloc_command_export();
  return g.__wbindgen_export_3.set(t2, e5), t2;
}
function S(e5, t2) {
  try {
    ...
    let t3 = x(e6);
    g.__wbindgen_exn_store_command_export(t3);
  }
}
var C = 0;
var w = typeof TextEncoder < `u` ? new TextEncoder(`utf-8`) : { encode: () => {
  throw Error(`TextEncoder not available`);
} };
var T = typeof w.encodeInto == `function` ? function(e5, t2) {
  return w.encodeInto(e5, t2);
} : function(e5, t2) {
  let n2 = w.encode(e5);
...
function E(e5, t2, n2) {
  if (n2 === void 0) {
    let n3 = w.encode(e5), r3 = t2(n3.length, 1) >>> 0;
    return y().subarray(r3, r3 + n3.length).set(n3), C = n3.length, r3;
  }
  let r2 = e5.length, i2 = t2(r2, 1) >>> 0, a2 = y(), o2 = 0;
  for (; o2 < r2; o2++) {
  ...
  if (o2 !== r2) {
    ...
    let t3 = y().subarray(i2 + o2, i2 + r2), a3 = T(e5, t3);
...
var D = null;
function O() {
  return (D === null || D.buffer.detached === true || D.buffer.detached === void 0 && D.buffer !== g.memory.buffer) && (D = new DataView(g.memory.buffer)), D;
}
function k(e5) {
  return e5 == null;
}
...
function M(e5, t2) {
  ...
  return j().set(e5, n2 / 4), C = e5.length, n2;
}
function N(e5, t2) {
  let n2 = t2(e5.length * 1, 1) >>> 0;
  return y().set(e5, n2 / 1), C = e5.length, n2;
}
function ee(e5, t2) {
  let n2 = t2(e5.length * 4, 4) >>> 0;
  for (let t3 = 0; t3 < e5.length; t3++) {
    let r2 = x(e5[t3]);
    O().setUint32(n2 + 4 * t3, r2, true);
  }
  return C = e5.length, n2;
}
function te(e5, t2) {
  let n2 = E(e5, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), r2 = C, i2 = N(t2, g.__wbindgen_malloc_command_export), a2 = C;
  return g.register_font(n2, r2, i2, a2) !== 0;
}
var P = Object.freeze({ Forward: 0, 0: `Forward`, Reverse: 1, 1: `Reverse`, Bounce: 2, 2: `Bounce`, ReverseBounce: 3, 3: `ReverseBounce` });
var F = typeof FinalizationRegistry > `u` ? { register: () => {
}, unregister: () => {
} } : new FinalizationRegistry((e5) => g.__wbg_dotlottieplayerwasm_free(e5 >>> 0, 1));
var ne = class {
  __destroy_into_raw() {
    let e5 = this.__wbg_ptr;
    return this.__wbg_ptr = 0, F.unregister(this), e5;
  }
  free() {
    let e5 = this.__destroy_into_raw();
    g.__wbg_dotlottieplayerwasm_free(e5, 0);
  }
  clear_slot(e5) {
    let t2 = E(e5, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), n2 = C;
    return g.dotlottieplayerwasm_clear_slot(this.__wbg_ptr, t2, n2) !== 0;
  }
  is_playing() {
    return g.dotlottieplayerwasm_is_playing(this.__wbg_ptr) !== 0;
  }
  is_stopped() {
    return g.dotlottieplayerwasm_is_stopped(this.__wbg_ptr) !== 0;
  }
  layout_fit() {
    let e5, t2;
    try {
      let n2 = g.dotlottieplayerwasm_layout_fit(this.__wbg_ptr);
      return e5 = n2[0], t2 = n2[1], b(n2[0], n2[1]);
    } finally {
      g.__wbindgen_free_command_export(e5, t2, 1);
    }
  }
  loop_count() {
    return g.dotlottieplayerwasm_loop_count(this.__wbg_ptr) >>> 0;
  }
  poll_event() {
    return g.dotlottieplayerwasm_poll_event(this.__wbg_ptr);
  }
  reset_slot(e5) {
    let t2 = E(e5, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), n2 = C;
    return g.dotlottieplayerwasm_reset_slot(this.__wbg_ptr, t2, n2) !== 0;
  }
  set_layout(e5, t2, n2) {
    let r2 = E(e5, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), i2 = C;
    return g.dotlottieplayerwasm_set_layout(this.__wbg_ptr, r2, i2, t2, n2) !== 0;
  }
  set_marker(e5) {
    let t2 = E(e5, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), n2 = C;
    g.dotlottieplayerwasm_set_marker(this.__wbg_ptr, t2, n2);
  }
  clear_slots() {
    return g.dotlottieplayerwasm_clear_slots(this.__wbg_ptr) !== 0;
  }
  has_segment() {
    return g.dotlottieplayerwasm_has_segment(this.__wbg_ptr) !== 0;
  }
  is_complete() {
    return g.dotlottieplayerwasm_is_complete(this.__wbg_ptr) !== 0;
  }
  is_tweening() {
    return g.dotlottieplayerwasm_is_tweening(this.__wbg_ptr) !== 0;
  }
  reset_slots() {
    return g.dotlottieplayerwasm_reset_slots(this.__wbg_ptr) !== 0;
  }
  reset_theme() {
    return g.dotlottieplayerwasm_reset_theme(this.__wbg_ptr) !== 0;
  }
  segment_end() {
    return g.dotlottieplayerwasm_segment_end(this.__wbg_ptr);
  }
  set_quality(e5) {
    return g.dotlottieplayerwasm_set_quality(this.__wbg_ptr, e5) !== 0;
  }
  set_segment(e5, t2) {
    return g.dotlottieplayerwasm_set_segment(this.__wbg_ptr, e5, t2) !== 0;
  }
  static unload_font(e5) {
    let t2 = E(e5, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), n2 = C;
    return g.dotlottieplayerwasm_unload_font(t2, n2) !== 0;
  }
  animation_id() {
    let e5 = g.dotlottieplayerwasm_animation_id(this.__wbg_ptr), t2;
    return e5[0] !== 0 && (t2 = b(e5[0], e5[1]).slice(), g.__wbindgen_free_command_export(e5[0], e5[1] * 1, 1)), t2;
  }
  clear_marker() {
    g.dotlottieplayerwasm_clear_marker(this.__wbg_ptr);
  }
  emit_on_loop() {
    g.dotlottieplayerwasm_emit_on_loop(this.__wbg_ptr);
  }
  get_slot_ids() {
    return g.dotlottieplayerwasm_get_slot_ids(this.__wbg_ptr);
  }
  get_slot_str(e5) {
    let t2 = E(e5, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), n2 = C, r2 = g.dotlottieplayerwasm_get_slot_str(this.__wbg_ptr, t2, n2), i2;
    return r2[0] !== 0 && (i2 = b(r2[0], r2[1]).slice(), g.__wbindgen_free_command_export(r2[0], r2[1] * 1, 1)), i2;
  }
  marker_names() {
    return g.dotlottieplayerwasm_marker_names(this.__wbg_ptr);
  }
  set_autoplay(e5) {
    g.dotlottieplayerwasm_set_autoplay(this.__wbg_ptr, e5);
  }
  set_slot_str(e5, t2) {
    let n2 = E(e5, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), r2 = C, i2 = E(t2, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), a2 = C;
    return g.dotlottieplayerwasm_set_slot_str(this.__wbg_ptr, n2, r2, i2, a2) !== 0;
  }
  set_viewport(e5, t2, n2, r2) {
    return g.dotlottieplayerwasm_set_viewport(this.__wbg_ptr, e5, t2, n2, r2) !== 0;
  }
  total_frames() {
    return g.dotlottieplayerwasm_total_frames(this.__wbg_ptr);
  }
  clear_segment() {
    return g.dotlottieplayerwasm_clear_segment(this.__wbg_ptr) !== 0;
  }
  current_frame() {
    return g.dotlottieplayerwasm_current_frame(this.__wbg_ptr);
  }
  get_slot_type(e5) {
    let t2 = E(e5, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), n2 = C, r2 = g.dotlottieplayerwasm_get_slot_type(this.__wbg_ptr, t2, n2), i2;
    return r2[0] !== 0 && (i2 = b(r2[0], r2[1]).slice(), g.__wbindgen_free_command_export(r2[0], r2[1] * 1, 1)), i2;
  }
  get_slots_str() {
    let e5, t2;
    try {
      let n2 = g.dotlottieplayerwasm_get_slots_str(this.__wbg_ptr);
      return e5 = n2[0], t2 = n2[1], b(n2[0], n2[1]);
    } finally {
      g.__wbindgen_free_command_export(e5, t2, 1);
    }
  ...
  get_transform() {
    return g.dotlottieplayerwasm_get_transform(this.__wbg_ptr);
  }
  request_frame() {
    return g.dotlottieplayerwasm_request_frame(this.__wbg_ptr);
  }
  segment_start() {
    return g.dotlottieplayerwasm_segment_start(this.__wbg_ptr);
  }
  set_slots_str(e5) {
    let t2 = E(e5, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), n2 = C;
    return g.dotlottieplayerwasm_set_slots_str(this.__wbg_ptr, t2, n2) !== 0;
  }
  set_text_slot(e5, t2) {
    let n2 = E(e5, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), r2 = C, i2 = E(t2, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), a2 = C;
    return g.dotlottieplayerwasm_set_text_slot(this.__wbg_ptr, n2, r2, i2, a2) !== 0;
  }
  set_transform(e5) {
    let t2 = M(e5, g.__wbindgen_malloc_command_export), n2 = C;
    return g.dotlottieplayerwasm_set_transform(this.__wbg_ptr, t2, n2) !== 0;
  }
  sm_get_inputs() {
    return g.dotlottieplayerwasm_sm_get_inputs(this.__wbg_ptr);
  }
  sm_poll_event() {
    return g.dotlottieplayerwasm_sm_poll_event(this.__wbg_ptr);
  }
  sm_post_click(e5, t2) {
    g.dotlottieplayerwasm_sm_post_click(this.__wbg_ptr, e5, t2);
  }
  animation_size() {
    return g.dotlottieplayerwasm_animation_size(this.__wbg_ptr);
  }
  current_marker() {
    let e5 = g.dotlottieplayerwasm_current_marker(this.__wbg_ptr), t2;
    return e5[0] !== 0 && (t2 = b(e5[0], e5[1]).slice(), g.__wbindgen_free_command_export(e5[0], e5[1] * 1, 1)), t2;
  }
  layout_align_x() {
    return g.dotlottieplayerwasm_layout_align_x(this.__wbg_ptr);
  }
  layout_align_y() {
    return g.dotlottieplayerwasm_layout_align_y(this.__wbg_ptr);
  }
  load_animation(e5, t2, n2) {
    let r2 = E(e5, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), i2 = C;
    return g.dotlottieplayerwasm_load_animation(this.__wbg_ptr, r2, i2, t2, n2) !== 0;
  }
  loop_animation() {
    return g.dotlottieplayerwasm_loop_animation(this.__wbg_ptr) !== 0;
  }
  set_color_slot(e5, t2, n2, r2) {
    let i2 = E(e5, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), a2 = C;
    return g.dotlottieplayerwasm_set_color_slot(this.__wbg_ptr, i2, a2, t2, n2, r2) !== 0;
  }
  set_loop_count(e5) {
    g.dotlottieplayerwasm_set_loop_count(this.__wbg_ptr, e5);
  }
  set_theme_data(e5) {
    let t2 = E(e5, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), n2 = C;
    return g.dotlottieplayerwasm_set_theme_data(this.__wbg_ptr, t2, n2) !== 0;
  }
  sm_reset_input(e5) {
    let t2 = E(e5, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), n2 = C;
    g.dotlottieplayerwasm_sm_reset_input(this.__wbg_ptr, t2, n2);
  }
  manifest_string() {
    let e5, t2;
    try {
      let n2 = g.dotlottieplayerwasm_manifest_string(this.__wbg_ptr);
      return e5 = n2[0], t2 = n2[1], b(n2[0], n2[1]);
    } finally {
      g.__wbindgen_free_command_export(e5, t2, 1);
    }
  ...
  set_scalar_slot(e5, t2) {
    let n2 = E(e5, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), r2 = C;
    return g.dotlottieplayerwasm_set_scalar_slot(this.__wbg_ptr, n2, r2, t2) !== 0;
  }
  set_vector_slot(e5, t2, n2) {
    let r2 = E(e5, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), i2 = C;
    return g.dotlottieplayerwasm_set_vector_slot(this.__wbg_ptr, r2, i2, t2, n2) !== 0;
  }
  background_color() {
    return g.dotlottieplayerwasm_background_color(this.__wbg_ptr) >>> 0;
  }
  get_layer_bounds(e5) {
    let t2 = E(e5, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), n2 = C;
    return g.dotlottieplayerwasm_get_layer_bounds(this.__wbg_ptr, t2, n2);
  }
  get_pixel_buffer() {
    return g.dotlottieplayerwasm_get_pixel_buffer(this.__wbg_ptr);
  }
  segment_duration() {
    return g.dotlottieplayerwasm_segment_duration(this.__wbg_ptr);
  }
  sm_current_state() {
    let e5, t2;
    try {
      let n2 = g.dotlottieplayerwasm_sm_current_state(this.__wbg_ptr);
      return e5 = n2[0], t2 = n2[1], b(n2[0], n2[1]);
    } finally {
      g.__wbindgen_free_command_export(e5, t2, 1);
    }
  ...
  state_machine_id() {
    let e5 = g.dotlottieplayerwasm_state_machine_id(this.__wbg_ptr), t2;
    return e5[0] !== 0 && (t2 = b(e5[0], e5[1]).slice(), g.__wbindgen_free_command_export(e5[0], e5[1] * 1, 1)), t2;
  }
  get_state_machine(e5) {
    let t2 = E(e5, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), n2 = C, r2 = g.dotlottieplayerwasm_get_state_machine(this.__wbg_ptr, t2, n2), i2;
    return r2[0] !== 0 && (i2 = b(r2[0], r2[1]).slice(), g.__wbindgen_free_command_export(r2[0], r2[1] * 1, 1)), i2;
  }
  set_position_slot(e5, t2, n2) {
    let r2 = E(e5, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), i2 = C;
    return g.dotlottieplayerwasm_set_position_slot(this.__wbg_ptr, r2, i2, t2, n2) !== 0;
  }
  current_loop_count() {
    return g.dotlottieplayerwasm_current_loop_count(this.__wbg_ptr) >>> 0;
  }
  sm_framework_setup() {
    return g.dotlottieplayerwasm_sm_framework_setup(this.__wbg_ptr);
  }
  sm_post_pointer_up(e5, t2) {
    g.dotlottieplayerwasm_sm_post_pointer_up(this.__wbg_ptr, e5, t2);
  }
  state_machine_load(e5) {
    let t2 = E(e5, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), n2 = C;
    return g.dotlottieplayerwasm_state_machine_load(this.__wbg_ptr, t2, n2) !== 0;
  }
  load_dotlottie_data(e5, t2, n2) {
    let r2 = N(e5, g.__wbindgen_malloc_command_export), i2 = C;
    return g.dotlottieplayerwasm_load_dotlottie_data(this.__wbg_ptr, r2, i2, t2, n2) !== 0;
  }
  sm_get_string_input(e5) {
    let t2 = E(e5, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), n2 = C, r2 = g.dotlottieplayerwasm_sm_get_string_input(this.__wbg_ptr, t2, n2), i2;
    return r2[0] !== 0 && (i2 = b(r2[0], r2[1]).slice(), g.__wbindgen_free_command_export(r2[0], r2[1] * 1, 1)), i2;
  }
  sm_set_string_input(e5, t2) {
    let n2 = E(e5, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), r2 = C, i2 = E(t2, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), a2 = C;
    return g.dotlottieplayerwasm_sm_set_string_input(this.__wbg_ptr, n2, r2, i2, a2) !== 0;
  }
  set_background_color(e5) {
    return g.dotlottieplayerwasm_set_background_color(this.__wbg_ptr, e5) !== 0;
  }
  sm_get_boolean_input(e5) {
    let t2 = E(e5, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), n2 = C, r2 = g.dotlottieplayerwasm_sm_get_boolean_input(this.__wbg_ptr, t2, n2);
    return r2 === 16777215 ? void 0 : r2 !== 0;
  }
  sm_get_numeric_input(e5) {
    let t2 = E(e5, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), n2 = C, r2 = g.dotlottieplayerwasm_sm_get_numeric_input(this.__wbg_ptr, t2, n2);
    return r2 === 4294967297 ? void 0 : r2;
  }
  sm_post_pointer_down(e5, t2) {
    g.dotlottieplayerwasm_sm_post_pointer_down(this.__wbg_ptr, e5, t2);
  }
  sm_post_pointer_exit(e5, t2) {
    g.dotlottieplayerwasm_sm_post_pointer_exit(this.__wbg_ptr, e5, t2);
  }
  sm_post_pointer_move(e5, t2) {
    g.dotlottieplayerwasm_sm_post_pointer_move(this.__wbg_ptr, e5, t2);
  }
  sm_set_boolean_input(e5, t2) {
    let n2 = E(e5, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), r2 = C;
    return g.dotlottieplayerwasm_sm_set_boolean_input(this.__wbg_ptr, n2, r2, t2) !== 0;
  }
  sm_set_numeric_input(e5, t2) {
    let n2 = E(e5, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), r2 = C;
    return g.dotlottieplayerwasm_sm_set_numeric_input(this.__wbg_ptr, n2, r2, t2) !== 0;
  }
  state_machine_unload() {
    g.dotlottieplayerwasm_state_machine_unload(this.__wbg_ptr);
  }
  sm_post_pointer_enter(e5, t2) {
    g.dotlottieplayerwasm_sm_post_pointer_enter(this.__wbg_ptr, e5, t2);
  }
  clear_background_color() {
    return g.dotlottieplayerwasm_clear_background_color(this.__wbg_ptr) !== 0;
  }
  load_animation_from_id(e5, t2, n2) {
    let r2 = E(e5, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), i2 = C;
    return g.dotlottieplayerwasm_load_animation_from_id(this.__wbg_ptr, r2, i2, t2, n2) !== 0;
  }
  sm_poll_internal_event() {
    return g.dotlottieplayerwasm_sm_poll_internal_event(this.__wbg_ptr);
  }
  use_frame_interpolation() {
    return g.dotlottieplayerwasm_use_frame_interpolation(this.__wbg_ptr) !== 0;
  }
  reset_current_loop_count() {
    g.dotlottieplayerwasm_reset_current_loop_count(this.__wbg_ptr);
  }
  sm_override_current_state(e5, t2) {
    let n2 = E(e5, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), r2 = C;
    return g.dotlottieplayerwasm_sm_override_current_state(this.__wbg_ptr, n2, r2, t2) !== 0;
  }
  state_machine_load_from_id(e5) {
    let t2 = E(e5, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), n2 = C;
    return g.dotlottieplayerwasm_state_machine_load_from_id(this.__wbg_ptr, t2, n2) !== 0;
  }
  set_use_frame_interpolation(e5) {
    g.dotlottieplayerwasm_set_use_frame_interpolation(this.__wbg_ptr, e5);
  }
  constructor() {
    return this.__wbg_ptr = g.dotlottieplayerwasm_new() >>> 0, F.register(this, this.__wbg_ptr, this), this;
  }
  mode() {
    return g.dotlottieplayerwasm_mode(this.__wbg_ptr);
  }
  play() {
    return g.dotlottieplayerwasm_play(this.__wbg_ptr) !== 0;
  }
  seek(e5) {
    return g.dotlottieplayerwasm_seek(this.__wbg_ptr, e5) !== 0;
  }
  stop() {
    return g.dotlottieplayerwasm_stop(this.__wbg_ptr) !== 0;
  }
  tick() {
    return g.dotlottieplayerwasm_tick(this.__wbg_ptr) !== 0;
  }
  clear() {
    g.dotlottieplayerwasm_clear(this.__wbg_ptr);
  }
  pause() {
    return g.dotlottieplayerwasm_pause(this.__wbg_ptr) !== 0;
  }
  speed() {
    return g.dotlottieplayerwasm_speed(this.__wbg_ptr);
  }
  width() {
    return g.dotlottieplayerwasm_width(this.__wbg_ptr) >>> 0;
  }
  height() {
    return g.dotlottieplayerwasm_height(this.__wbg_ptr) >>> 0;
  }
  render() {
    return g.dotlottieplayerwasm_render(this.__wbg_ptr) !== 0;
  }
  resize(e5, t2) {
    return g.dotlottieplayerwasm_resize(this.__wbg_ptr, e5, t2) !== 0;
  }
  markers() {
    return g.dotlottieplayerwasm_markers(this.__wbg_ptr);
  }
  sm_fire(e5) {
    let t2 = E(e5, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), n2 = C;
    return g.dotlottieplayerwasm_sm_fire(this.__wbg_ptr, t2, n2) !== 0;
  }
  sm_stop() {
    return g.dotlottieplayerwasm_sm_stop(this.__wbg_ptr) !== 0;
  }
  sm_tick() {
    return g.dotlottieplayerwasm_sm_tick(this.__wbg_ptr) !== 0;
  }
  autoplay() {
    return g.dotlottieplayerwasm_autoplay(this.__wbg_ptr) !== 0;
  }
  duration() {
    return g.dotlottieplayerwasm_duration(this.__wbg_ptr);
  }
  set_loop(e5) {
    g.dotlottieplayerwasm_set_loop(this.__wbg_ptr, e5);
  }
  set_mode(e5) {
    g.dotlottieplayerwasm_set_mode(this.__wbg_ptr, e5);
  }
  sm_start(e5, t2) {
    let n2 = ee(t2, g.__wbindgen_malloc_command_export), r2 = C;
    return g.dotlottieplayerwasm_sm_start(this.__wbg_ptr, e5, n2, r2) !== 0;
  }
  theme_id() {
    let e5 = g.dotlottieplayerwasm_theme_id(this.__wbg_ptr), t2;
    return e5[0] !== 0 && (t2 = b(e5[0], e5[1]).slice(), g.__wbindgen_free_command_export(e5[0], e5[1] * 1, 1)), t2;
  }
  intersect(e5, t2, n2) {
    let r2 = E(n2, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), i2 = C;
    return g.dotlottieplayerwasm_intersect(this.__wbg_ptr, e5, t2, r2, i2) !== 0;
  }
  is_loaded() {
    return g.dotlottieplayerwasm_is_loaded(this.__wbg_ptr) !== 0;
  }
  is_paused() {
    return g.dotlottieplayerwasm_is_paused(this.__wbg_ptr) !== 0;
  }
  load_font(e5, t2) {
    let n2 = E(e5, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), r2 = C, i2 = N(t2, g.__wbindgen_malloc_command_export), a2 = C;
    return g.dotlottieplayerwasm_load_font(this.__wbg_ptr, n2, r2, i2, a2) !== 0;
  }
  set_frame(e5) {
    return g.dotlottieplayerwasm_set_frame(this.__wbg_ptr, e5) !== 0;
  }
  set_speed(e5) {
    g.dotlottieplayerwasm_set_speed(this.__wbg_ptr, e5);
  }
  set_theme(e5) {
    let t2 = E(e5, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), n2 = C;
    return g.dotlottieplayerwasm_set_theme(this.__wbg_ptr, t2, n2) !== 0;
  }
  sm_status() {
    let e5, t2;
    try {
      let n2 = g.dotlottieplayerwasm_sm_status(this.__wbg_ptr);
      return e5 = n2[0], t2 = n2[1], b(n2[0], n2[1]);
    } finally {
      g.__wbindgen_free_command_export(e5, t2, 1);
    }
...
function ie() {
  ...
  return e5.wbg = {}, e5.wbg.__wbg_buffer_609cc3eee51ed158 = function(e6) {
    ...
    let n2, r2;
    try {
      n2 = e6, r2 = t2, console.error(b(e6, t2));
    } finally {
      g.__wbindgen_free_command_export(n2, r2, 1);
    }
    ...
    let n2 = t2.stack, r2 = E(n2, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), i2 = C;
    O().setInt32(e6 + 4, i2, true), O().setInt32(e6 + 0, r2, true);
  }, e5.wbg.__wbindgen_init_externref_table = function() {
    let e6 = g.__wbindgen_export_3, t2 = e6.grow(4);
    ...
    var i2 = k(r2) ? 0 : E(r2, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), a2 = C;
    O().setInt32(e6 + 4, a2, true), O().setInt32(e6 + 0, i2, true);
...
function ae(e5, t2) {
  return g = e5.exports, I.__wbindgen_wasm_module = t2, D = null, A = null, v = null, g.__wbindgen_start(), g;
}
async function I(e5) {
  ...
  let { instance: n2, module: r2 } = await re(await e5, t2);
  return ae(n2, r2);
}
var L = class {
  constructor() {
    s(this, `_eventListeners`, /* @__PURE__ */ new Map());
  }
  ...
  dispatch(e5) {
    var _a;
    (_a = this._eventListeners.get(e5.type)) == null ? void 0 : _a.forEach((t2) => t2(e5));
  }
...
var R = class e2 {
  ...
  static observe(t2, n2) {
    var _a;
    e2._initializeObserver(), !e2._observedCanvases.has(t2) && (e2._observedCanvases.set(t2, n2), (_a = e2._observer) == null ? void 0 : _a.observe(t2));
  }
  static unobserve(t2) {
    var _a, _b;
    (_a = e2._observer) == null ? void 0 : _a.unobserve(t2), e2._observedCanvases.delete(t2), e2._observedCanvases.size === 0 && ((_b = e2._observer) == null ? void 0 : _b.disconnect(), e2._observer = null);
  }
};
s(R, `_observer`, null), s(R, `_observedCanvases`, /* @__PURE__ */ new Map());
var z = class e3 {
  static _initializeObserver() {
  ...
  static observe(t2, n2) {
    var _a;
    e3._initializeObserver(), !e3._observedCanvases.has(t2) && (e3._observedCanvases.set(t2, [n2, 0]), (_a = e3._observer) == null ? void 0 : _a.observe(t2));
  }
  static unobserve(t2) {
    var _a;
    ...
    (_a = e3._observer) == null ? void 0 : _a.unobserve(t2), e3._observedCanvases.delete(t2), !e3._observedCanvases.size && e3._observer && (e3._observer.disconnect(), e3._observer = null);
  }
};
s(z, `_observer`, null), s(z, `_observedCanvases`, /* @__PURE__ */ new Map());
function oe(e5) {
...
function se(e5) {
  if (!oe(e5)) return 0;
  let t2 = e5.replace(`#`, ``);
  return t2 = t2.length === 6 ? `${t2}ff` : t2, parseInt(t2, 16);
}
function B(e5) {
  if (e5.byteLength < 4) return false;
  let t2 = new Uint8Array(e5.slice(0, f.byteLength));
  for (let e6 = 0; e6 < f.length; e6 += 1) if (f[e6] !== t2[e6]) return false;
  return true;
}
function V(e5) {
  return p.every((t2) => Object.hasOwn(e5, t2));
}
function H(e5) {
...
function U() {
  return 1 + ((d ? window.devicePixelRatio : 1) - 1) * 0.75;
}
function W(e5) {
...
var q = ce(I, `https://cdn.jsdelivr.net/npm/${h}@${m}/dist/dotlottie-player.wasm`, `https://unpkg.com/${h}@${m}/dist/dotlottie-player.wasm`);
var J = (e5) => {
  switch (e5) {
    case `reverse`:
      return P.Reverse;
...
var Y = class {
  constructor(e5) {
    var _a, _b;
    s(this, `_canvas`, null), s(this, `_pendingLoad`, null), s(this, `_context`, null), s(this, `_eventManager`, void 0), s(this, `_animationFrameId`, null), s(this, `_frameManager`, void 0), s(this, `_dotLottieCore`, null), s(this, `_stateMachineId`, ``), s(this, `_stateMachineConfig`, null), s(this, `_isStateMachineRunning`, false), s(this, `_renderConfig`, {}), s(this, `_isFrozen`, false), s(this, `_backgroundColor`, null), s(this, `_boundOnClick`, null), s(this, `_boundOnPointerUp`, null), s(this, `_boundOnPointerDown`, null), s(this, `_boundOnPointerMove`, null), s(this, `_boundOnPointerEnter`, null), s(this, `_boundOnPointerLeave`, null), s(this, `_bufferMismatchCount`, 0), s(this, `_lastExpectedBufferSize`, 0), s(this, `_marker`, ``), this._canvas = e5.canvas ?? null, this._eventManager = new L(), this._frameManager = new u(), this._renderConfig = { ...e5.renderConfig, devicePixelRatio: ((_a = e5.renderConfig) == null ? void 0 : _a.devicePixelRatio) || U(), freezeOnOffscreen: ((_b = e5.renderConfig) == null ? void 0 : _b.freezeOnOffscreen) ?? true }, this._initWasm().then(() => {
      var _a2, _b2, _c, _d, _e2;
      this._dotLottieCore = this._createCore(), this._dotLottieCore.set_autoplay(e5.autoplay ?? false), this._dotLottieCore.set_loop(e5.loop ?? false), this._dotLottieCore.set_loop_count(e5.loopCount ?? 0), this._dotLottieCore.set_mode(J(e5.mode ?? `forward`)), this._dotLottieCore.set_speed(e5.speed ?? 1), this._dotLottieCore.set_use_frame_interpolation(e5.useFrameInterpolation ?? true), e5.segment && e5.segment.length === 2 && this._dotLottieCore.set_segment(e5.segment[0], e5.segment[1]), this._marker = e5.marker ?? ``, this._marker && this._dotLottieCore.set_marker(this._marker), this._dotLottieCore.set_layout(((_a2 = e5.layout) == null ? void 0 : _a2.fit) ?? `contain`, ((_c = (_b2 = e5.layout) == null ? void 0 : _b2.align) == null ? void 0 : _c[0]) ?? 0.5, ((_e2 = (_d = e5.layout) == null ? void 0 : _d.align) == null ? void 0 : _e2[1]) ?? 0.5), this._stateMachineId = e5.stateMachineId ?? ``, this._stateMachineConfig = e5.stateMachineConfig ?? null, this._onCoreCreated(), this._eventManager.dispatch({ type: `ready` }), e5.data ? this._canvas ? this._loadFromData(e5.data) : this._pendingLoad = { data: e5.data } : e5.src && (this._canvas ? this._loadFromSrc(e5.src) : this._pendingLoad = { src: e5.src }), e5.backgroundColor && this.setBackgroundColor(e5.backgroundColor);
    }).catch((e6) => {
    ...
    for (; (e5 = this._dotLottieCore.poll_event()) != null; ) {
      ...
      switch (t2.type) {
        ...
        case `Stop`:
          ...
          break;
        case `Frame`:
          setTimeout(() => this._eventManager.dispatch({ type: `frame`, currentFrame: t2.frameNo ?? 0 }), 0);
          break;
        case `Render`:
          setTimeout(() => this._eventManager.dispatch({ type: `render`, currentFrame: t2.frameNo ?? 0 }), 0);
          break;
        case `Loop`:
          setTimeout(() => this._eventManager.dispatch({ type: `loop`, loopCount: t2.loopCount ?? 0 }), 0);
          break;
        case `Complete`:
  ...
  _drainSmEvents() {
    ...
    for (; (e5 = this._dotLottieCore.sm_poll_event()) != null; ) {
      ...
      switch (t3.type) {
        ...
        case `Stop`:
          setTimeout(() => {
            var _a;
            this._isStateMachineRunning = false, this._eventManager.dispatch({ type: `stateMachineStop` }), ((_a = this._dotLottieCore) == null ? void 0 : _a.is_playing()) || this._stopAnimationLoop();
          }, 0);
          break;
        case `CustomEvent`:
    ...
    for (; (t2 = this._dotLottieCore.sm_poll_internal_event()) != null; ) {
      ...
      if (e6.type === `Message`) {
        let t3 = e6.message ?? ``;
        d && t3.startsWith(`OpenUrl: `) ? K(t3) : this._eventManager.dispatch({ type: `stateMachineInternalMessage`, message: t3 });
      }
    }
  }
  _dispatchError(e5) {
  ...
  _loadFromData(e5) {
    ...
    if (typeof e5 == `string`) {
      ...
      r2 = this._dotLottieCore.load_dotlottie_data(new Uint8Array(e5), t2, n2);
      ...
      r2 = this._dotLottieCore.load_animation(JSON.stringify(e5), t2, n2);
    } else {
  ...
  get activeAnimationId() {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.animation_id()) ?? void 0;
  }
  get activeThemeId() {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.theme_id()) ?? void 0;
  }
  get layout() {
    if (this._dotLottieCore) return { align: [this._dotLottieCore.layout_align_x(), this._dotLottieCore.layout_align_y()], fit: ue(this._dotLottieCore.layout_fit()) };
  }
  get marker() {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.current_marker()) ?? ``;
  }
  get manifest() {
    var _a;
    try {
      let e5 = (_a = this._dotLottieCore) == null ? void 0 : _a.manifest_string();
  ...
  get loop() {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.loop_animation()) ?? false;
  }
  get mode() {
    return this._dotLottieCore ? le(this._dotLottieCore.mode()) : `forward`;
  }
  get isFrozen() {
  ...
  get autoplay() {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.autoplay()) ?? false;
  }
  get useFrameInterpolation() {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.use_frame_interpolation()) ?? false;
  }
  get speed() {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.speed()) ?? 0;
  }
  get isReady() {
  ...
  get isLoaded() {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.is_loaded()) ?? false;
  }
  get isPlaying() {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.is_playing()) ?? false;
  }
  get isPaused() {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.is_paused()) ?? false;
  }
  get isStopped() {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.is_stopped()) ?? false;
  }
  get currentFrame() {
  ...
  get loopCount() {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.current_loop_count()) ?? 0;
  }
  get totalFrames() {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.total_frames()) ?? 0;
  }
  get duration() {
    var _a;
  ...
  get segmentDuration() {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.segment_duration()) ?? 0;
  }
  get canvas() {
    return this._canvas;
  }
  load(e5) {
    var _a, _b, _c, _d, _e2;
    this._dotLottieCore !== null && (this._stopAnimationLoop(), this._cleanupCanvas(), this._isFrozen = false, this._dotLottieCore.set_autoplay(e5.autoplay ?? false), this._dotLottieCore.set_loop(e5.loop ?? false), this._dotLottieCore.set_loop_count(e5.loopCount ?? 0), this._dotLottieCore.set_mode(J(e5.mode ?? `forward`)), this._dotLottieCore.set_speed(e5.speed ?? 1), this._dotLottieCore.set_use_frame_interpolation(e5.useFrameInterpolation ?? true), e5.segment && e5.segment.length === 2 ? this._dotLottieCore.set_segment(e5.segment[0], e5.segment[1]) : this._dotLottieCore.clear_segment(), this._marker = e5.marker ?? ``, this._marker ? this._dotLottieCore.set_marker(this._marker) : this._dotLottieCore.clear_marker(), this._dotLottieCore.set_layout(((_a = e5.layout) == null ? void 0 : _a.fit) ?? `contain`, ((_c = (_b = e5.layout) == null ? void 0 : _b.align) == null ? void 0 : _c[0]) ?? 0.5, ((_e2 = (_d = e5.layout) == null ? void 0 : _d.align) == null ? void 0 : _e2[1]) ?? 0.5), e5.data ? this._canvas ? this._loadFromData(e5.data) : this._pendingLoad = { data: e5.data } : e5.src && (this._canvas ? this._loadFromSrc(e5.src) : this._pendingLoad = { src: e5.src }), this.setBackgroundColor(e5.backgroundColor ?? ``));
  }
  _draw() {
  ...
  _cleanupCanvas() {
    this._canvas && d && this._canvas instanceof HTMLCanvasElement && (R.unobserve(this._canvas), z.unobserve(this._canvas), this._cleanupStateMachineListeners());
  }
  _initializeCanvas() {
    this._setupRendererOnCanvas(), this._canvas && d && this._canvas instanceof HTMLCanvasElement && this.isLoaded && (this._renderConfig.freezeOnOffscreen && (R.observe(this._canvas, this), W(this._canvas) || this.freeze()), this._renderConfig.autoResize && z.observe(this._canvas, this), this._isStateMachineRunning && this._setupStateMachineListeners()), this._canvas && this._dotLottieCore && this.isLoaded && this._dotLottieCore.resize(this._canvas.width, this._canvas.height) && (this._dotLottieCore.render(), this._draw());
  }
  ...
  _animationLoop() {
    ...
    try {
      ...
      console.error(`Error in animation frame:`, e5), this._eventManager.dispatch({ type: `renderError`, error: e5 }), e5 instanceof WebAssembly.RuntimeError && this.destroy();
    }
  }
  play() {
    ...
    this._drainPlayerEvents(), (e5 || this._dotLottieCore.is_playing()) && (this._isFrozen = false, this._startAnimationLoop()), this._canvas && d && this._canvas instanceof HTMLCanvasElement && this._renderConfig.freezeOnOffscreen && !W(this._canvas) && this.freeze();
  }
  pause() {
  ...
  setBackgroundColor(e5) {
    this._dotLottieCore !== null && (d && this._canvas instanceof HTMLCanvasElement ? this._canvas.style.backgroundColor = e5 : this._dotLottieCore.set_background_color(se(e5)), this._backgroundColor = e5);
  }
  setLoop(e5) {
  ...
  destroy() {
    var _a;
    this._stopAnimationLoop(), this._isStateMachineRunning = false, this._cleanupCanvas(), (_a = this._dotLottieCore) == null ? void 0 : _a.free(), this._dotLottieCore = null, this._context = null, this._eventManager.dispatch({ type: `destroy` }), this._eventManager.removeAllEventListeners(), this._cleanupStateMachineListeners();
  }
  freeze() {
  ...
  resize() {
    if (!(!this._dotLottieCore || !this.isLoaded || !this._canvas)) {
      if (d && this._canvas instanceof HTMLCanvasElement) {
      ...
      this._dotLottieCore.resize(this._canvas.width, this._canvas.height) && (this._dotLottieCore.render(), this._draw());
    }
  }
  setCanvas(e5) {
  ...
  markers() {
    var _a;
    let e5 = (_a = this._dotLottieCore) == null ? void 0 : _a.markers();
  ...
  setColorSlot(e5, t2) {
    if (this._dotLottieCore === null) return false;
    let n2 = this._isKeyframeArray(t2), r2 = JSON.stringify({ a: n2 ? 1 : 0, k: t2 }), i2 = this._dotLottieCore.set_slot_str(e5, r2);
    return this._dotLottieCore.render(), this._draw(), i2;
  }
  setScalarSlot(e5, t2) {
    if (this._dotLottieCore === null) return false;
    let n2 = typeof t2 != `number`, r2 = JSON.stringify({ a: n2 ? 1 : 0, k: t2 }), i2 = this._dotLottieCore.set_slot_str(e5, r2);
    return this._dotLottieCore.render(), this._draw(), i2;
  }
  setVectorSlot(e5, t2) {
    if (this._dotLottieCore === null) return false;
  ...
  setGradientSlot(e5, t2, n2) {
    if (this._dotLottieCore === null) return false;
    let r2 = this._isKeyframeArray(t2), i2 = JSON.stringify({ k: { a: r2 ? 1 : 0, k: t2 }, p: n2 }), a2 = this._dotLottieCore.set_slot_str(e5, i2);
  ...
  setLayout(e5) {
    var _a, _b;
    this._dotLottieCore !== null && this._dotLottieCore.set_layout(e5.fit ?? `contain`, ((_a = e5.align) == null ? void 0 : _a[0]) ?? 0.5, ((_b = e5.align) == null ? void 0 : _b[1]) ?? 0.5);
  }
  ...
  animationSize() {
    var _a;
    let e5 = (_a = this._dotLottieCore) == null ? void 0 : _a.animation_size();
    return { width: (e5 == null ? void 0 : e5[0]) ?? 0, height: (e5 == null ? void 0 : e5[1]) ?? 0 };
  }
  getLayerBoundingBox(e5) {
    var _a;
    let t2 = (_a = this._dotLottieCore) == null ? void 0 : _a.get_layer_bounds(e5);
  ...
  stateMachineStart() {
    var _a, _b, _c, _d;
    if (this._dotLottieCore === null) return false;
    let e5 = this._dotLottieCore.sm_start(((_b = (_a = this._stateMachineConfig) == null ? void 0 : _a.openUrlPolicy) == null ? void 0 : _b.requireUserInteraction) ?? true, ((_d = (_c = this._stateMachineConfig) == null ? void 0 : _c.openUrlPolicy) == null ? void 0 : _d.whitelist) ?? []);
  ...
  stateMachineGetStatus() {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.sm_status()) ?? ``;
  }
  stateMachineGetCurrentState() {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.sm_current_state()) ?? ``;
  }
  stateMachineGetActiveId() {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.state_machine_id()) ?? ``;
  }
  stateMachineOverrideState(e5, t2 = false) {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.sm_override_current_state(e5, t2)) ?? false;
  }
  stateMachineGet(e5) {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.get_state_machine(e5)) ?? ``;
  }
  ...
  stateMachineSetBooleanInput(e5, t2) {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.sm_set_boolean_input(e5, t2)) ?? false;
  }
  stateMachineSetNumericInput(e5, t2) {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.sm_set_numeric_input(e5, t2)) ?? false;
  }
  stateMachineSetStringInput(e5, t2) {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.sm_set_string_input(e5, t2)) ?? false;
  }
  stateMachineGetBooleanInput(e5) {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.sm_get_boolean_input(e5)) ?? void 0;
  }
  stateMachineGetNumericInput(e5) {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.sm_get_numeric_input(e5)) ?? void 0;
  }
  stateMachineGetStringInput(e5) {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.sm_get_string_input(e5)) ?? void 0;
  }
  ...
  stateMachineFireEvent(e5) {
    var _a;
    (_a = this._dotLottieCore) == null ? void 0 : _a.sm_fire(e5);
  }
  stateMachinePostClickEvent(e5, t2) {
    var _a;
    (_a = this._dotLottieCore) == null ? void 0 : _a.sm_post_click(e5, t2);
  }
  stateMachinePostPointerUpEvent(e5, t2) {
    var _a;
    (_a = this._dotLottieCore) == null ? void 0 : _a.sm_post_pointer_up(e5, t2);
  }
  stateMachinePostPointerDownEvent(e5, t2) {
    var _a;
    (_a = this._dotLottieCore) == null ? void 0 : _a.sm_post_pointer_down(e5, t2);
  }
  stateMachinePostPointerMoveEvent(e5, t2) {
    var _a;
    (_a = this._dotLottieCore) == null ? void 0 : _a.sm_post_pointer_move(e5, t2);
  }
  stateMachinePostPointerEnterEvent(e5, t2) {
    var _a;
    (_a = this._dotLottieCore) == null ? void 0 : _a.sm_post_pointer_enter(e5, t2);
  }
  stateMachinePostPointerExitEvent(e5, t2) {
    var _a;
    (_a = this._dotLottieCore) == null ? void 0 : _a.sm_post_pointer_exit(e5, t2);
  }
  _onClick(e5) {
    let t2 = G(e5);
  ...
  _setupStateMachineListeners() {
    if (d && this._canvas instanceof HTMLCanvasElement && this._dotLottieCore !== null && this.isLoaded) {
...
var Q = class e4 {
  constructor(t2) {
    var _a, _b;
    if (s(this, `_eventManager`, new L()), s(this, `_id`, void 0), s(this, `_worker`, void 0), s(this, `_canvas`, void 0), s(this, `_dotLottieInstanceState`, { loopCount: 0, markers: [], autoplay: false, backgroundColor: ``, currentFrame: 0, duration: 0, loop: false, mode: `forward`, segment: [0, 0], segmentDuration: 0, speed: 1, totalFrames: 0, isLoaded: false, isPlaying: false, isPaused: false, isStopped: true, isFrozen: false, useFrameInterpolation: false, renderConfig: { devicePixelRatio: U() }, activeAnimationId: ``, activeThemeId: ``, layout: void 0, marker: ``, isReady: false, manifest: null }), s(this, `_created`, false), s(this, `_boundOnClick`, null), s(this, `_boundOnPointerUp`, null), s(this, `_boundOnPointerDown`, null), s(this, `_boundOnPointerMove`, null), s(this, `_boundOnPointerEnter`, null), s(this, `_boundOnPointerLeave`, null), s(this, `_pendingConfig`, null), t2.canvas) {
    ...
    this._canvas = t2.canvas ?? null, this._id = `dotlottie-${Z()}`;
  ...
  async _create(e5) {
    ...
    let { instanceId: n2 } = await this._sendMessage(`create`, { instanceId: this._id, config: { ...e5, canvas: t2 }, ...X(this._canvas, ((_a = e5.renderConfig) == null ? void 0 : _a.devicePixelRatio) || U()) }, [t2]);
  ...
  async play() {
    this._created && (await this._sendMessage(`play`, { instanceId: this._id }), await this._updateDotLottieInstanceState(), d && this._canvas instanceof HTMLCanvasElement && this._dotLottieInstanceState.renderConfig.freezeOnOffscreen && !W(this._canvas) && await this.freeze());
  }
  async pause() {
  ...
  async resize() {
    ...
    let { height: e5, width: t2 } = X(this._canvas, this._dotLottieInstanceState.renderConfig.devicePixelRatio || U());
    await this._sendMessage(`resize`, { height: e5, instanceId: this._id, width: t2 }), await this._updateDotLottieInstanceState();
  }
  async destroy() {
    this._created && (this._created = false, await this._sendMessage(`destroy`, { instanceId: this._id }), this._cleanupStateMachineListeners(), e4._workerManager.unassignAnimationFromWorker(this._id), this._eventManager.removeAllEventListeners(), d && this._canvas instanceof HTMLCanvasElement && (R.unobserve(this._canvas), z.unobserve(this._canvas)));
  }
  async freeze() {
  ...
  async _updateDotLottieInstanceState() {
    this._created && (this._dotLottieInstanceState = (await this._sendMessage(`getDotLottieInstanceState`, { instanceId: this._id })).state);
  }
  markers() {
  ...
  async _sendMessage(e5, t2, n2) {
    let r2 = { id: `dotlottie-request-${Z()}`, method: e5, params: t2 };
...
s(Q, `_workerManager`, new fe()), s(Q, `_wasmUrl`, ``);
var $ = ({ animationId: i2, autoplay: a2, backgroundColor: o2, className: s2, createDotLottie: c2, data: l2, dotLottieRefCallback: u2, layout: d2, loop: f2, mode: p2, playOnHover: m2, renderConfig: h2, segment: g2, speed: _2, src: v2, stateMachineConfig: y2, stateMachineId: b2, style: x2, themeData: S2, themeId: C2, useFrameInterpolation: w2, workerId: T2, ...E2 }) => {
  var _a, _b;
  let D2 = (0, import_react.useRef)(null), O2 = (0, import_react.useRef)(null), k2 = (0, import_react.useRef)(u2), A2 = { speed: _2, mode: p2, loop: f2, useFrameInterpolation: w2, segment: g2, backgroundColor: o2, autoplay: a2, themeId: C2, workerId: T2, src: v2, data: l2, layout: d2, renderConfig: h2, animationId: i2, stateMachineConfig: y2, stateMachineId: b2 }, j2 = (0, import_react.useRef)(A2);
  k2.current = u2, j2.current = A2;
  let M2 = (0, import_react.useCallback)((e5) => {
    var _a2, _b2;
    O2.current = e5, e5 ? D2.current = c2({ ...j2.current, canvas: e5 }) : ((_a2 = D2.current) == null ? void 0 : _a2.destroy(), D2.current = null), (_b2 = k2.current) == null ? void 0 : _b2.call(k2, D2.current);
  }, []);
  return (0, import_react.useEffect)(() => {
    var _a2, _b2;
    let e5 = (e6) => {
      var _a3, _b3;
      m2 && (e6.type === `mouseenter` && ((_a3 = D2.current) == null ? void 0 : _a3.play()), e6.type === `mouseleave` && ((_b3 = D2.current) == null ? void 0 : _b3.pause()));
    };
    return (_a2 = O2.current) == null ? void 0 : _a2.addEventListener(`mouseenter`, e5), (_b2 = O2.current) == null ? void 0 : _b2.addEventListener(`mouseleave`, e5), () => {
      var _a3, _b3;
      (_a3 = O2.current) == null ? void 0 : _a3.removeEventListener(`mouseenter`, e5), (_b3 = O2.current) == null ? void 0 : _b3.removeEventListener(`mouseleave`, e5);
    };
  }, [m2]), (0, import_react.useEffect)(() => {
    var _a2;
    (_a2 = D2.current) == null ? void 0 : _a2.setSpeed(_2 ?? 1);
  }, [_2]), (0, import_react.useEffect)(() => {
    var _a2;
    (_a2 = D2.current) == null ? void 0 : _a2.setMode(p2 ?? `forward`);
  }, [p2]), (0, import_react.useEffect)(() => {
    var _a2;
    (_a2 = D2.current) == null ? void 0 : _a2.setLoop(f2 ?? false);
  }, [f2]), (0, import_react.useEffect)(() => {
    var _a2;
    (_a2 = D2.current) == null ? void 0 : _a2.setUseFrameInterpolation(w2 ?? true);
  }, [w2]), (0, import_react.useEffect)(() => {
    var _a2;
    typeof (g2 == null ? void 0 : g2[0]) == `number` && typeof g2[1] == `number` && ((_a2 = D2.current) == null ? void 0 : _a2.setSegment(g2[0], g2[1]));
  }, [g2]), (0, import_react.useEffect)(() => {
    var _a2;
    (_a2 = D2.current) == null ? void 0 : _a2.setBackgroundColor(o2 ?? ``);
  }, [o2]), (0, import_react.useEffect)(() => {
    var _a2;
    (_a2 = D2.current) == null ? void 0 : _a2.setRenderConfig(h2 ?? {});
  }, [JSON.stringify(h2)]), (0, import_react.useEffect)(() => {
    var _a2;
    typeof l2 != `string` && typeof l2 != `object` || ((_a2 = D2.current) == null ? void 0 : _a2.load({ data: l2, ...j2.current }));
  }, [l2]), (0, import_react.useEffect)(() => {
    var _a2;
    typeof v2 == `string` && ((_a2 = D2.current) == null ? void 0 : _a2.load({ src: v2, ...j2.current }));
  }, [v2]), (0, import_react.useEffect)(() => {
    var _a2;
    (_a2 = D2.current) == null ? void 0 : _a2.setMarker(E2.marker ?? ``);
  }, [E2.marker]), (0, import_react.useEffect)(() => {
    var _a2;
    ((_a2 = D2.current) == null ? void 0 : _a2.isLoaded) && D2.current.activeAnimationId !== i2 && D2.current.loadAnimation(i2 ?? ``);
  }, [i2]), (0, import_react.useEffect)(() => {
    var _a2;
    typeof C2 == `string` && ((_a2 = D2.current) == null ? void 0 : _a2.setTheme(C2));
  }, [C2]), (0, import_react.useEffect)(() => {
    var _a2;
    (_a2 = D2.current) == null ? void 0 : _a2.setThemeData(S2 ?? ``);
  }, [S2]), (0, import_react.useEffect)(() => {
    var _a2;
    (_a2 = D2.current) == null ? void 0 : _a2.setLayout(d2 ?? {});
  }, [d2 == null ? void 0 : d2.fit, (_a = d2 == null ? void 0 : d2.align) == null ? void 0 : _a[0], (_b = d2 == null ? void 0 : d2.align) == null ? void 0 : _b[1]]), (0, import_react.useEffect)(() => {
    var _a2;
    ((_a2 = D2.current) == null ? void 0 : _a2.isLoaded) && (typeof b2 == `string` && b2 ? D2.current.stateMachineLoad(b2) && D2.current.stateMachineStart() : D2.current.stateMachineStop());
  }, [b2]), (0, import_react.useEffect)(() => {
    var _a2;
    (_a2 = D2.current) == null ? void 0 : _a2.stateMachineSetConfig(y2 ?? null);
  }, [y2]), (0, import_jsx_runtime.jsx)(`div`, { className: s2, ...!s2 && { style: { width: `100%`, height: `100%`, lineHeight: 0, ...x2 } }, children: (0, import_jsx_runtime.jsx)(`canvas`, { ref: M2, style: { width: `100%`, height: `100%` }, ...E2 }) });
};
var pe = (e5) => new Y(e5);
var me = (e5) => (0, import_jsx_runtime.jsx)($, { ...e5, createDotLottie: pe });
var he = (e5) => new Q(e5);
var ge = (e5) => (0, import_jsx_runtime.jsx)($, { ...e5, createDotLottie: he });
var _e = (e5) => {
  Q.setWasmUrl(e5), Y.setWasmUrl(e5);
};
export {
  me as DotLottieReact,
  ge as DotLottieWorkerReact,
  _e as setWasmUrl
};
